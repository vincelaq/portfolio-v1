        ...
        <div id='about' className='flex flex-col ml-24 mb-72 justify-start items-center bg-navy max-w-4xl'>
            ...
            <div className='flex flex-row pt-6'>
                <div className='basis-3/5 font-Inter text-slate'>
                    ...
                    Fast-forward today, I’ve created and develop quite a few independent projects which can be found on my GitHub or Work section of my portfolio. Here are a few technologies I've been working with:
